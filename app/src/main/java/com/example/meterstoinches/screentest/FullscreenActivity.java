...
public class FullscreenActivity extends AppCompatActivity {
    ...
    private Button invsButton;
    private int[] colors = new int[] {Color.BLACK,Color.WHITE,Color.GREEN,Color.BLUE,Color.RED,Color.GRAY};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        invsButton = (Button) findViewById(R.id.dummy_button);
        invsButton.setText(R.string.dummy_button);
        mainView = findViewById(R.id.mainView);

        invsButton.setOnClickListener(new View.OnClickListener() {
            @Override
